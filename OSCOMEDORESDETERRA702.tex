...
Tudo isso não aconteceu embaixo deste céu, mas do céu que caiu\footnote{Queda do céu: Referência à história sobre a queda do céu anterior ao que existe hoje, contada no volume desta mesma série, \emph{O surgimento dos pássaros}.} e amassou
...
existência dos nossos antepassados, antes de algum \emph{napë},\footnote{O termo \emph{napë} designa os estrangeiros, em geral os brancos, ou quem adotou seus costumes.} entre
nós, perguntar assim:
