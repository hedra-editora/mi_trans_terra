\hyphenation{Yoa-hi-wë}
\hyphenation{pë-pɨ-ta-rio-ma}
\hyphenation{yã-xaa-mou}
\hyphenation{na-pë-pra-rio-ma}
\hyphenation{xoa-ray-oma}
...
Tudo isso não aconteceu embaixo deste céu, mas do céu que caiu\footnote{Queda do céu: Referência à história sobre a queda do céu anterior ao que existe hoje, contada no volume desta mesma coleção, \textit{O surgimento dos pássaros}.} e amassou
...
--- Wa totihiwë? --- të pë kuɨ nikereo mao tëhë, napë a kunomi.\looseness=-1
...
Ele fez muitos buracos, Pica-Pau-Vermelho. Foi ele quem resolveu o
 ...
 quem fez Horonamɨ descer, tirando-o \mbox{daquela} situação. É o nome dele
...
\letra{H}{ekura} të pë wãha hayuamopë, kamiyë pëma kɨ nohi patama rë përɨonowei të
...
--- Wa iaɨ hëo! --- e pë kuma. Ɨha, a ta pëtɨa hërɨ! --- e pë kuma.\looseness=-1 
...
A partir do momento que o tuxaua\footnote{No Amazonas, onde vivem as comunidades de Ajuricaba e Komixipɨwei,
...
tradução.} Horonamɨ sumiu, Yoahiwë soprou a
...
\textls[-5]{Apesar de ser recém-nascida, \textit{paha}! Ela não soprava devagar.}\looseness=-1 
...
fugia, transformou-se em espírito. Os dois irmãos, Yoahiwë e Omawë, correram e seguiram pelo rio, zangados.
...
rë a wãha Yoawë kuoma.\looseness=-1
...
os dois fossem anambés-azuis\footnote{O anambé-azul fornece penas azuis usadas para fazer os brincos dos
pajés.} muito bonitos. 

--- Que passarinho bonito! --- Vocês dizem assim, pois Omawë era bonito.
Foi para ele que a mulher se entregou. 

O irmão mais velho de Omawë se chamava Hëɨmɨriwë, Anambé-Azul, e queria se transformar em
anambé-azul; o nome do irmão mais novo era Omawë,
...
Ele sorriu. Lá, aquelas raízes saídas da terra pareciam enormes.\looseness=-1
...
--- \textit{Kopou}! \textit{Ũi, ũi, ũi, ũi, ũi, ũi}! --- a kuɨ he yatiyo hërɨma --- Wa mixi
...
--- Hape, hẽaroyë kë a. Ya yurema, a ma rë riëhëi --- a noã tama.\looseness=-1 

E të kahe pata watëkarioma. Heinaha kama e kuma. 

\textls[-5]{Kihi kë të ko pë pata hẽraxa urerewë hawë nasi kɨ pë pata ureremoma. E të wãrima, pë tëë iha, ɨ̃hɨ ei rë a kãi rë keparuhe iha.}\looseness=-1 
...
A água logo jorrou longe. O jorro caiu lá, bem embaixo. A~água se
...
mortos lá bem perto da terra dos \textit{napë}, lá embaixo. Chegavam
...
Ele raspava os corpos cremados com um tipo de colher grande. \textit{Xoe}! \textit{Xoe}! \textit{Xoe}! A pele dos cremados produzia esse som.\looseness=-1 
...
Të amipɨ wai prokea hërɨɨ ha, pë xɨɨnɨ a mɨa no yupoma, amixiri.\looseness=-1 
...
\textls[-7]{Depois do surgimento de Japu, lá os ancestrais dos Waika, dos Xamatari,
